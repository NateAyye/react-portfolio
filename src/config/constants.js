...
import designDepoImg from '../assets/images/design-depo.png';
...
export const LINKS = ['About Me', 'Portfolio', 'Resume', 'Contact Me'];

export const PROJECTS = [
  {
    title: 'Design Depo',
    repo: 'https://github.com/NateAyye/design-depo',
    site: 'https://design-depo-50c7f040c26d.herokuapp.com/',
    image: designDepoImg,
    stack: 'MERN Stack',
  },
  {
